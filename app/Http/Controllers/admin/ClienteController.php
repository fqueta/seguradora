...
class ClienteController extends Controller
{
    ...
    public function campos($dados=false,$local='index'){
        ...
        $ret = [
            ...
            'config[celular]'=>['label'=>'Telefone celular','active'=>false,'type'=>'tel','tam'=>'4','exibe_busca'=>'d-block','event'=>'onblur=mask(this,clientes_mascaraTelefone); onkeypress=mask(this,clientes_mascaraTelefone);','cp_busca'=>'config][celular'],
